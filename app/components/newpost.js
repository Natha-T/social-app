...
export default function NewPost() {
  return (
    <div className="mb-16">
      <p class="heading text-center font-bold text-2xl m-5 text-gray-800">
        New Post
      </p>
      <div class="">
        <form className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
          <input
          ...
          <Dropdown />{" "}
          <textarea
            class="description mt-4 bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none"
            spellcheck="false"
          ...
          <div class="buttons flex">
            ...
            <button class="btn border border-indigo-500 p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2 bg-indigo-500">
              Post
            </button>
          </div>
        </form>
